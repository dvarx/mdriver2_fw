...
//*****************************************************************************
/*
 * segments that we are receiving have a payload of 100 bytes
 */
#define LWIP_TCP                        1
//#define TCP_TTL                         // Time-To-Live for outgoing TCP packets
#define TCP_WND                         4096   // TCP receive window size: maximum data that uC can buffer before sending an ACK
