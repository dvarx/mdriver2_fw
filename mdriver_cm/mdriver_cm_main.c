/*
 * ############################################################
 * CM program code for MDriver2 control board based on TMS320F28388S v1.0
...
uint8_t buffer[BUFFER_SIZE];                    //a buffer storing the last received bytes
...
main(void)
{
    ...
    //
    // Initializing the CM. Loading the required functions to SRAM. Establishing IPC to CPU1
    //
    CM_init();
    //clear all ipc flags
